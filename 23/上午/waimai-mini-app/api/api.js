...
// method：GET
// params: code(Y)
const USETR_LOGIN_API = 'http://localhost:9000' + '/meituan/api/login';

// 检查用户是否登录过
// method：GET
// params: TOKEN(Y)
const USETR_CHECKLOGIN_API = 'http://localhost:9000' + '/meituan/api/check_login';

// 保存用户信息
// method：POST
// params: TOKEN(Y) .......
const USETR_SAVE_INFO_API = 'http://localhost:9000' + '/meituan/api/save_userinfo';

// 获得用户信息
// method：GET
// params: TOKEN(Y)
const USETR_GET_INFO_API = 'http://localhost:9000' + '/meituan/api/get_userinfo';
